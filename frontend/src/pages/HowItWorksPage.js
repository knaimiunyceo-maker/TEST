      ...
      <section id="concept" className="py-16 px-4 sm:px-6 lg:px-12 bg-warmwhite">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="font-dm text-ocean/80 text-lg max-w-2xl mx-auto mb-8">
            THE BRIDGE combines skill-building with travel. Every day follows the same rhythm: 
            practice your chosen skill in the morning, explore Morocco in the afternoon. 
            It's not just a holiday — it's a transformation.
          </p>
          <div className="grid sm:grid-cols-2 gap-4 max-w-xl mx-auto">
            <Card className="border-none bg-white">
              <CardContent className="p-4 text-center">
                <p className="font-syne font-bold text-ocean mb-1">Morning</p>
                <p className="font-dm text-ocean/70 text-sm">Training & Practice Sessions</p>
              </CardContent>
            </Card>
            <Card className="border-none bg-white">
              <CardContent className="p-4 text-center">
                <p className="font-syne font-bold text-ocean mb-1">Afternoon</p>
                <p className="font-dm text-ocean/70 text-sm">Exploration & Group Activities</p>
              </CardContent>
            </Card>
          </div>
        </div>
