...
const translations = {
  ...
  de: {
    ...
    topExperiences: {
      ...
      "hammam": { title: "Traditionelles Marokkanisches Hammam", description: "Erleben Sie das authentische marokkanische Spa-Ritual. Entspannen Sie im Dampfbad, genießen Sie ein traditionelles Peeling mit schwarzer Seife und kommen Sie völlig verjüngt heraus." }
    },
    activityNames: {
  ...
  pt: {
    ...
    topExperiences: {
      ...
      "hammam": { title: "Hammam Marroquino Tradicional", description: "Viva o autêntico ritual de spa marroquino. Relaxe na sala de vapor, desfrute de uma esfoliação tradicional com sabão preto e saia completamente rejuvenescido." }
    },
    activityNames: {
      "surf": "Surf", "kitesurf": "Kitesurf", "sup": "Stand Up Paddle", "yoga": "Yoga", "pilates": "Pilates",
  ...
  it: {
    ...
    topExperiences: {
      ...
      "hammam": { title: "Hammam Marocchino Tradizionale", description: "Vivi l'autentico rituale spa marocchino. Rilassati nella sala vapore, goditi uno scrub tradizionale con sapone nero ed esci completamente rigenerato." }
    },
    activityNames: {
      "surf": "Surf", "kitesurf": "Kitesurf", "sup": "Stand Up Paddle", "yoga": "Yoga", "pilates": "Pilates",
