...
import { 
  Dumbbell, ArrowRight, MapPin, Calendar, Users, Check, 
  Clock, ChevronDown, ChevronUp, Star, Shield, Heart
} from "lucide-react";
...
const PROGRAM = [
  ...
  { day: "Day 2", morning: "Boxing fundamentals", afternoon: "Pool time & local exploration" },
  { day: "Day 3", morning: "Muay Thai techniques", afternoon: "Beach excursion (Agadir) or Medina tour" },
  { day: "Day 4", morning: "Self-defense training", afternoon: "Free time & optional massage" },
  { day: "Day 5", morning: "Mixed training session", afternoon: "Group dinner & departure (5-day)" },
  { day: "Day 6", morning: "Advanced techniques", afternoon: "Desert excursion (optional)" },
...
const FAQ = [
  ...
  { q: "What should I bring?", a: "Comfortable training clothes, swimwear, sunscreen. Boxing gloves are provided but you can bring your own if preferred." },
  { q: "Is accommodation included?", a: "Yes, accommodation in partner hostels or guesthouses is included in the price." },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="font-dm text-white/80 text-lg max-w-2xl">
              Morning training sessions in Boxing, Muay Thai, and Self-defense. 
              Afternoons for beach, pool, exploration, and group experiences.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="font-dm text-ocean/80 text-base leading-relaxed mb-6">
                Join our Combat & Self-Defense Holiday for an unforgettable experience combining 
                martial arts training with Moroccan adventure. Each morning, train with experienced 
                coaches in boxing, Muay Thai, and practical self-defense techniques.
              </p>
              <p className="font-dm text-ocean/80 text-base leading-relaxed mb-6">
                Afternoons are yours to enjoy — relax by the pool in Marrakech, hit the beach in 
                Agadir, explore local markets, or simply unwind. End your days with group dinners 
                and new friendships from around the world.
              </p>
              <div className="flex flex-wrap gap-3">
                {["Boxing", "Muay Thai", "Self-defense"].map((item) => (
            ...
            <div className="grid grid-cols-2 gap-4">
              <img src="https://images.unsplash.com/photo-1549719386-74dfcbf7dbed?w=400" alt="Boxing" className="rounded-xl aspect-square object-cover" />
              <img src="https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=400" alt="Training" className="rounded-xl aspect-square object-cover mt-8" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="locations" className="py-16 px-4 sm:px-6 lg:px-12 bg-warmwhite">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              { city: "Marrakech", desc: "Train in the heart of Morocco. Pool time, medina exploration, vibrant nightlife.", image: "https://images.unsplash.com/photo-1597212618440-806262de4f6b?w=400" },
              { city: "Agadir", desc: "Beach vibes and surf culture. Morning training, afternoon beach sessions.", image: "https://images.unsplash.com/photo-1596627116790-af6f46dddbf4?w=400" }
            ].map((loc) => (
      ...
      <section id="book" className="py-16 px-4 sm:px-6 lg:px-12 bg-sunset text-white text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="font-dm text-white/80 mb-6">
            Book your Combat & Self-Defense Holiday today and start your journey.
          </p>
...
export default CombatHolidayPage;
